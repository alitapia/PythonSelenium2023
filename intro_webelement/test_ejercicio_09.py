...
class TestLandingPage:
    ...
    def test_download_complete(self):
        ...
        download_button = self.__find_clickable_element(By.XPATH, "//button[@id='downloadButton']")
        download_button.click()
        self.__find_by_text(By.XPATH, "//div[@class='progress-label']", "Complete")
        self.__find_visible_element(By.XPATH, "//div[@class='ui-dialog-buttonset']//button[@type='button']")
